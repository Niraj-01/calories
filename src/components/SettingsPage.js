      ...
      <section className={styles.frostedGlass}>
        ...
        >
          <span className={styles.navLeft}>
            ...
            <span className={styles.navLabel}>Dashboard &amp; Insights</span>
          </span>
          <svg width="8" height="13" viewBox="0 0 8 13" fill="none" stroke="#C7C5BD" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M1.5 1.5l5 5-5 5" /></svg>
        </button>
      </section>
